...
F_ARROW  = ('Segoe UI', 16, 'bold')   # ◄ ► arrow buttons
    ...
    ly = [
        ...
        [sg.Column([[
            sg.Button('  LOGIN  ', key='LG_OK',
                      font=('Segoe UI',13,'bold'), button_color=(C_WHITE,C_BLUE),
                      border_width=1, bind_return_key=True, pad=(10,5)),
            sg.Button('  EXIT  ', key='LG_EXIT',
                      font=('Segoe UI',13,'bold'), button_color=(C_WHITE,'#7F1D1D'),
...
def _plot_console(canvas_key, lbl_key, prev_key, next_key,
    ...
    return (
        ...
        [[
            ...
            sg.Text('  Double-click plot to zoom', font=('Segoe UI',11),
...
OPT_LEFT = (
    ...
    [sec_hdr('OUTPUT CONSTRAINTS', C_RED),
     ...
     [lbl('Max Gene-Swap Steps',24), inp('ITERMAX','5',8),
      sg.Text('(Algorithm 1 max-crossover)', font=('Segoe UI',12),
              text_color=C_DIM, background_color=C_PANEL)],
...
OPT_RIGHT = (
    [sec_hdr('OPTIMAL RESULT', C_CYAN),
     ...
     [sg.Text(_TOP5_INFO, font=('Segoe UI',11), text_color=C_DIM,
...
ENV_LEFT = (
    [sec_hdr('GEOMETRY SOURCE', C_AMBER),
     ...
     [sg.Text('', key='OPT_GEO_STATUS', font=('Segoe UI',12),
